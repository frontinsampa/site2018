        ...
        <ul data-menu role="menubar">
            ...
            return (
		      ...
		      <li {...styles.header_nav_link}>
		      	<Button tabIndex="3" type={'outline'} label="INGRESSOS ESGOTADOS" link="https://www.sympla.com.br/front-in-sampa-2018__193402" target={'_blank'}  rel="noopener noreferrer" />
          </li>
        </ul>
      </nav>
      </div>
