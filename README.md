...
```
git clone git@github.com:frontinsampa/site2018.git
cd site2018
```
...
Update packages in your branch just typing `yarn install` at your terminal.

Always check the [Create React App Changelog](https://github.com/facebookincubator/create-react-app/blob/master/CHANGELOG.md). If your `react-scripts` is an older version, update it by:

```
yarn add --exact react-scripts@1.0.17
```

Add new packages: yarn add `package-name`

## Tests

To run test and snpachats suit:
```
yarn test
```

We use these plugins to create and run tests:
- Jest

## Issues

View all [issues](https://github.com/frontinsampa/site2018/issues), open [new issue](https://github.com/frontinsampa/site2018/issues/new) for help.
...
Read and update all documentation [here](https://github.com/frontinsampa/site2018/wiki)

## Contact

Join us on [frontinsampa@gmail.com](mailto:frontinsampa@gmail.com)

## Contributions

This is an open source project lively inside this company meanwhile. You can pull it into your machine, help us testing it and send bug fixes and improvements through [Pull Requests](https://github.com/frontinsampa/site2018/pulls). 
...
# create-react-app read me (from Facebook Incubator)

This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).

Here you will find some information on how to perform common tasks.<br>
